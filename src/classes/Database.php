...
class Database extends PDO{
    public function __construct(string $dsn, string $username, string $password, array $options = []){
        // Imposta leopzioni di default di PDO
        ...
        $options = array_replace($default_options, $options); // sostituisce i default
        parent::__construct($dsn, $username, $password, $options); // creo l'oggetto PDO
    }
